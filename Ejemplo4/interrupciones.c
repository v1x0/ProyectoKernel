...
/**********************************************************************/
/* Para llamar scripts en modo usuario                                */
...
/*                                                                    */
/* Definiciones para poder manejar un pin de gpio como interrupciones */
...
/* static umh_test(void){                                             */
/*   char *argv[] = { "/bin/pwm","1", NULL };                         */
/*   static char *envp[] = {                                          */
/*        "HOME=/",                                                   */
/*        "TERM=linux",                                               */
...
/*			IRQF_TRIGGER_FALLING,GPIO_ANY_GPIO_DESC,      */
